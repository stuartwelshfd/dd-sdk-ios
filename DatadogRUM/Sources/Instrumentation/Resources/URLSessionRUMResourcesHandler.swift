...
extension DistributedTracing {
    func modify(request: URLRequest, headerTypes: Set<DatadogInternalLegacy.TracingHeaderType>, rumSessionId: String?) -> (URLRequest, TraceContext?) {
    ...
    func trace(from interception: DatadogInternalLegacy.URLSessionTaskInterception) -> RUMSpanContext? {
